...
(function() {
    ...
    return mk_request(request_options, (function(_this) {
      return function(error, response, body) {
        ...
        return parser.parseString(body, function(error, json) {
          var Z, channel, channel_idx, entry, item, tag, tags, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
          if (error != null) {
            return handler(error);
          }
          Z = [];
          _ref = json['channel'];
          for (channel_idx = _i = 0, _len = _ref.length; _i < _len; channel_idx = ++_i) {
            channel = _ref[channel_idx];
            _ref1 = channel['item'];
  ...
  this.filter_for_tags = function(rss, tags) {
    return rss.filter((function(_this) {
      return function(entry) {
        var tag, _i, _len;
        for (_i = 0, _len = tags.length; _i < _len; _i++) {
          tag = tags[_i];
          if (entry['tags'][tag] == null) {
            return false;
          }
        }
        return true;
